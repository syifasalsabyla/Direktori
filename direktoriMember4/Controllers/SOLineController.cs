...
using direktoriMember4.Data;
using direktoriMember4.Models;

namespace direktoriMember4.Controllers
{
    public class SOLineController : Controller
    {
        ...
        {
            ViewData["ProdukID"] = new SelectList(_context.Produk, "ProdukID", "NamaProduk");
        ...
        public async Task<IActionResult> Create([Bind("SOLineID,SOHeaderID,ProdukID,Quantity,Keterangan")] SOLine sOLine)
        {
            ...
            ViewData["ProdukID"] = new SelectList(_context.Produk, "ProdukID", "NamaProduk", sOLine.ProdukID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SOLineID,SOHeaderID,ProdukID,Quantity,Keterangan")] SOLine sOLine)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
           // return RedirectToAction("Delete", "SOHeader", new { id = sOLine.SOHeader });
            return RedirectToAction(nameof(Index));
        }
